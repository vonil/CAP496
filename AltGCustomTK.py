...
####################################################################################### 
        ...
        self.balloon.bind(importDataCubeBtn, "Import VTK/VTS file and display Data in Mayavi window.")

        # Import button VTK/VTS files
        ...
        self.balloon.bind(generate_data_btn, "Generate data points for the current position of the scalar cut plane.")

        # Slice button to reset data points
        ...
        self.balloon.bind(new_slice_button, "Reset data points list for a new slice.")
    ...
    def generate_slice_data(self, z_depth):
        ...
        for x in np.arange(x_start, x_end, x_interval):
            for y in np.arange(y_start, y_end, y_interval):
                if len(self.data_points) >= 500:                                           # Comment out these 3 lines #
                    print(f"Reached 500 data points limit. Stopping data generation.")     # to remove the limit on #
                    return  # Stop adding more points once 500 have been added             # Data points.          #
...
# If you want to use a matplotlib for displaying 
     # def load_vtk_file(self):
